                    ...
                    <form action="{{ route('stock-exits.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-input id="exit_date" class="block mt-1 w-full bg-gray-700 text-gray-200 border-gray-600" type="date" name="exit_date" :value="old('exit_date', date('Y-m-d'))" required />
                                @error('exit_date')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
