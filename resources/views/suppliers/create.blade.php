                    ...
                    <form action="{{ route('suppliers.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 animate-slide-in-left">
                            ...
                            <div>
                                ...
                                <x-input id="contact_name" class="block mt-1 w-full bg-gray-700 text-gray-200 border-gray-600" type="text" name="contact_name" :value="old('contact_name')" />
                                @error('contact_name')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <x-input id="email" class="block mt-1 w-full bg-gray-700 text-gray-200 border-gray-600" type="email" name="email" :value="old('email')" />
                                @error('email')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <x-input id="phone" class="block mt-1 w-full bg-gray-700 text-gray-200 border-gray-600" type="text" name="phone" :value="old('phone')" />
                                @error('phone')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="address" name="address" rows="3" class="block mt-1 w-full border-gray-600 bg-gray-700 text-gray-200 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('address') }}</textarea>
                                @error('address')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
